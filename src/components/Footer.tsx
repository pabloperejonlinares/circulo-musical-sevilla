...
const INSTAGRAM_URL = "https://instagram.com/circulomusicaldesevilla";
const WHATSAPP_URL = "https://wa.me/34691196341";
...
function SocialIconLink({
  ...
  return (
    <a
      ...
      aria-label={label}
      className={`inline-flex size-10 items-center justify-center rounded-full border border-default-200 bg-content1 text-default-600 shadow-sm transition-colors hover:border-transparent hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary ${className ?? ""}`}
    >
      {children}
    </a>
  );
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-2 space-y-1 text-sm text-default-700">
              <p>De lunes a jueves, de 10:00 a 13:30 y de 16:00 a 20:30</p>
              <p>Viernes de 10:00 a 13:30 y de 16:00 a 19:00</p>
            </div>
          </div>
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-default-600">
            ...
            <VenueMapsLink className="mt-2 inline-block text-sm text-primary underline-offset-2 hover:underline" />
          </div>
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-default-600">
              Contacto
          ...
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
              <SocialIconLink
                href={FACEBOOK_URL}
                label="Facebook de Círculo Musical de Sevilla"
              ...
              <SocialIconLink
                href={INSTAGRAM_URL}
                label="Instagram de Círculo Musical de Sevilla"
                className="hover:bg-linear-to-br hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888]"
              >
                <IconInstagram />
              </SocialIconLink>
              <SocialIconLink
                href={WHATSAPP_URL}
                label="WhatsApp de Círculo Musical de Sevilla"
